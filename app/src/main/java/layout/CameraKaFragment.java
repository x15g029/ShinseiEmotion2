...
import layout.PictureCheckKaFragment;
 ...
 */
public class CameraKaFragment extends Fragment implements View.OnTouchListener ,EmotionEngine.EmotionListener{
    CameraPreview mCamera;
    private String path;

    public CameraKaFragment() {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        mCamera.setSaveListener(new CameraPreview.SaveListener() {
            ...
            public void onSave(Bitmap bitmap) {
                ...
                ft2.replace(R.id.layout_main,new PictureCheckKaFragment());
                ft2.commit();
            }
        });
        //写真撮影

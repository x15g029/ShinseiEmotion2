...
import layout.PictureCheckTiFragment;

/**
 * A simple {@link Fragment} subclass.
 */
public class CameraTiFragment extends Fragment implements View.OnTouchListener ,EmotionEngine.EmotionListener{
    CameraPreview mCamera;
    private String path;

    public CameraTiFragment() {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        mCamera.setSaveListener(new CameraPreview.SaveListener() {
            ...
            public void onSave(Bitmap bitmap) {
                ...
                ft2.replace(R.id.layout_main,new PictureCheckTiFragment());
                ft2.commit();
            }
        });
        //写真撮影
